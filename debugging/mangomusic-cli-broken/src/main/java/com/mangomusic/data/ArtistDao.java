...
public class ArtistDao {
	...
	public List<Artist> searchArtists(String searchTerm) {
		...
		// the connection object was not inside the try-with-resource
		// opening a connection
		try (Connection connection = dataManager.getConnection(); PreparedStatement statement = connection.prepareStatement(query)) {
